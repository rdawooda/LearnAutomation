...
public class VerifyLoginPageWithReport {
	...
	public void testHomePage()
	{
		...
		logger.log(LogStatus.INFO, logger.addScreenCapture(Helper.captureScreenshot(driver,"Test Case validation passed")));
	...
	public void tearDown(ITestResult result)
	{
		if(result.getStatus()==ITestResult.FAILURE)
		{
			...
			logger.log(LogStatus.FAIL, "Screenshot captured "+logger.addScreenCapture(path));
		}
